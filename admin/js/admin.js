...
function openMemberEdit(m) {
  $("editNik").value = m.nik || m.id; $("editName").value = m.name || ""; $("editPhone").value = m.phone || m.handphone || ""; $("editEmail").value = m.email || ""; $("editBirthPlace").value = m.birthPlace || ""; $("editBirthDate").value = m.birthDate || "";
